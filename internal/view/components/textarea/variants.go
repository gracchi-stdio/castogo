...
func textareaVariants(className string, borderless bool) string {
	...
	baseClasses := "placeholder:text-muted-foreground flex field-sizing-content min-h-16 w-full rounded-md bg-muted px-3 py-2 text-base text-foreground transition-[color,box-shadow] outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm"
